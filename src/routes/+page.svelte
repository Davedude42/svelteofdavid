...
let text: string = `<span style="background-color: dodgerblue; color: black; font-weight: 600;"> Welcome! </span>  
      
You may be wondering...  
 - What is this place?  
 - Why am I here?  
 - Who is this <span style="color: dodgerblue; font-weight: 600;">fine young man</span> standing next to the <a target="_blank" rel="noopener noreferrer" href="https://en.wikipedia.org/wiki/Continental_Divide_of_the_Americas" class="hover:underline">Continental Divide</a>? 
